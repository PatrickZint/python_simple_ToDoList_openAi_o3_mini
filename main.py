...
def main():
    ...
    # Define the phase of the pipeline to run
    phase = 4
    ...
    if phase == 2:
        ...
        specifications = spec_gen_agent.generate_specifications('outputs/refined_goals.txt', 'outputs/refined_environment.txt')
